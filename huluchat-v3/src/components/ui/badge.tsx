  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-all duration-200 ease-out focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        destructive:
          "border-transparent bg-destructive text-destructive-foreground hover:bg-destructive/80 active:scale-95",
        outline: "text-foreground hover:bg-muted/50 active:scale-95",
      },
    },
    defaultVariants: {
      variant: "default",
